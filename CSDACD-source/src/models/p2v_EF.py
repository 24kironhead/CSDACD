...
class PairEncoder(nn.Module):
    def __init__(self, in_ch, enc_chs=(16,32,64), add_chs=(0,0)):
        ...
        self.conv1 = SimpleResBlock(4*in_ch, enc_chs[0])
    ...
    def forward(self, x1, x2, xS2W, xW2S, add_feats=None):
        x = torch.cat([x1,x2,xS2W,xW2S], dim=1)
        feats = [x]
...
class P2VNet(nn.Module):
    def __init__(self, in_ch, video_len=12, enc_chs_p=(32,64,128), enc_chs_v=(64,128), dec_chs=(256,128,64,32)):
        ...
        self.decoder = SimpleDecoder(enc_chs_p[-1], (4*in_ch,)+enc_chs_p, dec_chs)
    ...
    def forward(self, xS, xW, xS2W, xW2S, return_aux=True):
        ...
        feats_p = self.encoder_p(xS, xW, xS2W, xW2S, feats_v)
